...
export const fleetState: RmfModels.FleetState = {
  name: 'test_fleet',
  robots: [
    makeRobot({
...
export const dispensers: WorkcellData[] = [{ guid: 'test_dispenser', location: [18, -9] }];

export const ingestors: WorkcellData[] = [{ guid: 'test_ingestor', location: [16, -9] }];
