...
/**
 * Information about the mutex groups that this robot is interacting with
 * @export
 * @interface MutexGroups
 */
export interface MutexGroups {
  /**
   * A list of mutex groups that this robot has currently locked
   * @type {Array<string>}
...
export class AlertsApi extends BaseAPI {
   ...
   * @memberof AlertsApi
   */
  public createNewAlertAlertsRequestPost(alertRequest: AlertRequest, options?: AxiosRequestConfig) {
   ...
   * @memberof AlertsApi
   */
  public getAlertAlertsRequestAlertIdGet(alertId: string, options?: AxiosRequestConfig) {
    return AlertsApiFp(this.configuration)
      .getAlertAlertsRequestAlertIdGet(alertId, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export class BuildingApi extends BaseAPI {
   ...
   * @memberof BuildingApi
   */
  public resetFireAlarmTriggerBuildingMapResetFireAlarmTriggerPost(options?: AxiosRequestConfig) {
    return BuildingApiFp(this.configuration)
      .resetFireAlarmTriggerBuildingMapResetFireAlarmTriggerPost(options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const RIOsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    putRioRiosPut: async (rio: Rio, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RIOsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    queryRiosRiosGet(id?: string, type?: string, options?: any): AxiosPromise<Array<Rio>> {
      return localVarFp
...
export class RIOsApi extends BaseAPI {
   ...
   * @memberof RIOsApi
   */
  public putRioRiosPut(rio: Rio, options?: AxiosRequestConfig) {
   ...
   * @memberof RIOsApi
   */
  public queryRiosRiosGet(id?: string, type?: string, options?: AxiosRequestConfig) {
    return RIOsApiFp(this.configuration)
      .queryRiosRiosGet(id, type, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const TasksApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {string} [pickup] pickup name. [deprecated] use &#x60;label&#x60; instead
     * @param {string} [destination] destination name, [deprecated] use &#x60;label&#x60; instead
