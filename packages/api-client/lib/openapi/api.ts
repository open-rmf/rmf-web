 ...
 * @export
 * @interface ApiServerModelsTortoiseModelsDeliveryAlertsDeliveryAlertLeaf
 */
export interface ApiServerModelsTortoiseModelsDeliveryAlertsDeliveryAlertLeaf {
  /**
   *
   * @type {string}
   * @memberof ApiServerModelsTortoiseModelsDeliveryAlertsDeliveryAlertLeaf
   */
  id: string;
  /**
  ...
  category: string;
  /**
   * Warning: warning<br/>Error: error
   * @type {string}
   * @memberof ApiServerModelsTortoiseModelsDeliveryAlertsDeliveryAlertLeaf
   */
  tier: string;
 ...
 *
 * @export
 * @interface ApiServerModelsTortoiseModelsTasksTaskQueueEntryLeaf
 */
export interface ApiServerModelsTortoiseModelsTasksTaskQueueEntryLeaf {
  /**
   *
   * @type {string}
   * @memberof ApiServerModelsTortoiseModelsTasksTaskQueueEntryLeaf
   */
  id_: string;
  /**
   *
...
export const DeliveryAlertsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    createDeliveryAlertDeliveryAlertsPost: async (
      category: string,
      tier: string,
      taskId: string,
      message: string,
      ...
      // verify required parameter 'category' is not null or undefined
      assertParamExists('createDeliveryAlertDeliveryAlertsPost', 'category', category);
      // verify required parameter 'tier' is not null or undefined
      assertParamExists('createDeliveryAlertDeliveryAlertsPost', 'tier', tier);
      // verify required parameter 'taskId' is not null or undefined
      assertParamExists('createDeliveryAlertDeliveryAlertsPost', 'taskId', taskId);
      // verify required parameter 'message' is not null or undefined
      assertParamExists('createDeliveryAlertDeliveryAlertsPost', 'message', message);
      const localVarPath = `/delivery_alerts`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet: async (
      deliveryAlertId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'deliveryAlertId' is not null or undefined
      assertParamExists(
        'getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet',
        'deliveryAlertId',
        deliveryAlertId,
      );
      const localVarPath = `/delivery_alerts/{delivery_alert_id}`.replace(
        `{${'delivery_alert_id'}}`,
     ...
     * @throws {RequiredError}
     */
    getDeliveryAlertsDeliveryAlertsGet: async (
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/delivery_alerts`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateDeliveryAlertActionDeliveryAlertsDeliveryAlertIdActionPost: async (
      deliveryAlertId: string,
      action: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'deliveryAlertId' is not null or undefined
      assertParamExists(
        'updateDeliveryAlertActionDeliveryAlertsDeliveryAlertIdActionPost',
        'deliveryAlertId',
        deliveryAlertId,
      );
      ...
      const localVarPath = `/delivery_alerts/{delivery_alert_id}/action`.replace(
        `{${'delivery_alert_id'}}`,
        encodeURIComponent(String(deliveryAlertId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DeliveryAlertsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createDeliveryAlertDeliveryAlertsPost(
      category: string,
      tier: string,
      taskId: string,
      message: string,
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ApiServerModelsTortoiseModelsDeliveryAlertsDeliveryAlertLeaf>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createDeliveryAlertDeliveryAlertsPost(
          category,
          tier,
          taskId,
          message,
     ...
     * @throws {RequiredError}
     */
    async getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet(
      deliveryAlertId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet(
          deliveryAlertId,
          options,
        );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
     ...
     * @throws {RequiredError}
     */
    async getDeliveryAlertsDeliveryAlertsGet(
      options?: AxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
     ...
     * @throws {RequiredError}
     */
    async updateDeliveryAlertActionDeliveryAlertsDeliveryAlertIdActionPost(
      deliveryAlertId: string,
      action: string,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateDeliveryAlertActionDeliveryAlertsDeliveryAlertIdActionPost(
          deliveryAlertId,
          action,
          options,
        );
...
export const DeliveryAlertsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createDeliveryAlertDeliveryAlertsPost(
      category: string,
      tier: string,
      taskId: string,
      message: string,
      ...
      return localVarFp
        .createDeliveryAlertDeliveryAlertsPost(category, tier, taskId, message, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet(
      ...
      return localVarFp
        .getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet(deliveryAlertId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getDeliveryAlertsDeliveryAlertsGet(
      options?: any,
    ): AxiosPromise<Array<ApiServerModelsTortoiseModelsDeliveryAlertsDeliveryAlertLeaf>> {
      return localVarFp
...
export class DeliveryAlertsApi extends BaseAPI {
   ...
   */
  public createDeliveryAlertDeliveryAlertsPost(
    category: string,
    tier: string,
    taskId: string,
    message: string,
   ...
   * @memberof DeliveryAlertsApi
   */
  public getDeliveryAlertDeliveryAlertsDeliveryAlertIdGet(
    deliveryAlertId: string,
    options?: AxiosRequestConfig,
  ) {
    return DeliveryAlertsApiFp(this.configuration)
   ...
   * @memberof DeliveryAlertsApi
   */
  public updateDeliveryAlertActionDeliveryAlertsDeliveryAlertIdActionPost(
    deliveryAlertId: string,
    action: string,
    options?: AxiosRequestConfig,
  ) {
...
export const TasksApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getTaskStatesTasksStatesGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      const localVarPath = `/tasks/states`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
  ...
  return {
    ...
    async getTaskQueueEntryTasksTaskIdQueueEntryGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ApiServerModelsTortoiseModelsTasksTaskQueueEntryLeaf>
    > {
      const localVarAxiosArgs =
     ...
     * @throws {RequiredError}
     */
    async getTaskStatesTasksStatesGet(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TaskState>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTaskStatesTasksStatesGet(
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    ...
    async queryTaskQueueEntryTasksQueueEntryGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ApiServerModelsTortoiseModelsTasksTaskQueueEntryLeaf>>
    > {
      const localVarAxiosArgs =
...
export const TasksApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getTaskStatesTasksStatesGet(options?: any): AxiosPromise<Array<TaskState>> {
      return localVarFp
        .getTaskStatesTasksStatesGet(options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    queryTaskStatesTasksGet(taskId?: string, options?: any): AxiosPromise<Array<TaskState>> {
      return localVarFp
        .queryTaskStatesTasksGet(taskId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class TasksApi extends BaseAPI {
   ...
   * @memberof TasksApi
   */
  public getTaskStatesTasksStatesGet(options?: AxiosRequestConfig) {
    return TasksApiFp(this.configuration)
      .getTaskStatesTasksStatesGet(options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof TasksApi
   */
  public queryTaskStatesTasksGet(taskId?: string, options?: AxiosRequestConfig) {
    return TasksApiFp(this.configuration)
      .queryTaskStatesTasksGet(taskId, options)
      .then((request) => request(this.axios, this.basePath));
  }
