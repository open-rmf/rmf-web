 ...
 *
 * @export
 * @interface MotionObjectModel
 */
export interface MotionObjectModel {
  /**
   *
   * @type {string}
   * @memberof MotionObjectModel
   */
  name: string;
  /**
   *
 ...
 *
 * @export
 * @interface VideoRoomModel
 */
export interface VideoRoomModel {
  /**
   *
   * @type {string}
   * @memberof VideoRoomModel
   */
  url: string;
}
...
/**
 * TeleoperationApi - axios parameter creator
 * @export
 */
export const TeleoperationApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    /**
     *
     * @summary Join Video Room
     * @param {string} name
     * @param {VideoRoomModel} videoRoomModel
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    joinVideoRoomTeleoperationNameVideoJoinPost: async (
      name: string,
      videoRoomModel: VideoRoomModel,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'name' is not null or undefined
      assertParamExists('joinVideoRoomTeleoperationNameVideoJoinPost', 'name', name);
      // verify required parameter 'videoRoomModel' is not null or undefined
      assertParamExists(
        'joinVideoRoomTeleoperationNameVideoJoinPost',
        'videoRoomModel',
        videoRoomModel,
      );
      const localVarPath = `/teleoperation/{name}/video/join`.replace(
        `{${'name'}}`,
        encodeURIComponent(String(name)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    leaveVideoRoomTeleoperationNameVideoLeavePost: async (
      name: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'name' is not null or undefined
      assertParamExists('leaveVideoRoomTeleoperationNameVideoLeavePost', 'name', name);
      const localVarPath = `/teleoperation/{name}/video/leave`.replace(
        `{${'name'}}`,
        encodeURIComponent(String(name)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @summary Move
     * @param {string} name
     * @param {MotionObjectModel} motionObjectModel
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    moveTeleoperationNameMovePost: async (
      name: string,
      motionObjectModel: MotionObjectModel,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'name' is not null or undefined
      assertParamExists('moveTeleoperationNameMovePost', 'name', name);
      // verify required parameter 'motionObjectModel' is not null or undefined
      assertParamExists('moveTeleoperationNameMovePost', 'motionObjectModel', motionObjectModel);
      const localVarPath = `/teleoperation/{name}/move`.replace(
        `{${'name'}}`,
        encodeURIComponent(String(name)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
/**
 * TeleoperationApi - functional programming interface
 * @export
 */
export const TeleoperationApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator = TeleoperationApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Join Video Room
     ...
     * @throws {RequiredError}
     */
    async joinVideoRoomTeleoperationNameVideoJoinPost(
      name: string,
      videoRoomModel: VideoRoomModel,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.joinVideoRoomTeleoperationNameVideoJoinPost(
          name,
          videoRoomModel,
          options,
        );
     ...
     * @throws {RequiredError}
     */
    async leaveVideoRoomTeleoperationNameVideoLeavePost(
      name: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.leaveVideoRoomTeleoperationNameVideoLeavePost(
          name,
          options,
        );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
     ...
     * @throws {RequiredError}
     */
    async moveTeleoperationNameMovePost(
      name: string,
      motionObjectModel: MotionObjectModel,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.moveTeleoperationNameMovePost(
        name,
        motionObjectModel,
        options,
      );
...
/**
 * TeleoperationApi - factory interface
 * @export
 */
export const TeleoperationApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  const localVarFp = TeleoperationApiFp(configuration);
  return {
    /**
     *
     * @summary Join Video Room
    ...
    joinVideoRoomTeleoperationNameVideoJoinPost(
      ...
      return localVarFp
        .joinVideoRoomTeleoperationNameVideoJoinPost(name, videoRoomModel, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    leaveVideoRoomTeleoperationNameVideoLeavePost(name: string, options?: any): AxiosPromise<any> {
      return localVarFp
        .leaveVideoRoomTeleoperationNameVideoLeavePost(name, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    moveTeleoperationNameMovePost(
      name: string,
      motionObjectModel: MotionObjectModel,
      options?: any,
    ): AxiosPromise<any> {
      return localVarFp
        .moveTeleoperationNameMovePost(name, motionObjectModel, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
/**
 * TeleoperationApi - object-oriented interface
 * @export
 * @class TeleoperationApi
 * @extends {BaseAPI}
 */
export class TeleoperationApi extends BaseAPI {
  /**
   *
   * @summary Join Video Room
   * @param {string} name
   ...
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof TeleoperationApi
   */
  public joinVideoRoomTeleoperationNameVideoJoinPost(
    name: string,
    videoRoomModel: VideoRoomModel,
    options?: AxiosRequestConfig,
  ) {
    return TeleoperationApiFp(this.configuration)
      .joinVideoRoomTeleoperationNameVideoJoinPost(name, videoRoomModel, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof TeleoperationApi
   */
  public leaveVideoRoomTeleoperationNameVideoLeavePost(name: string, options?: AxiosRequestConfig) {
    return TeleoperationApiFp(this.configuration)
      .leaveVideoRoomTeleoperationNameVideoLeavePost(name, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof TeleoperationApi
   */
  public moveTeleoperationNameMovePost(
    name: string,
    motionObjectModel: MotionObjectModel,
    options?: AxiosRequestConfig,
  ) {
