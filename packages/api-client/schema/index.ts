export default {
  ...
  paths: {
    ...
    '/alerts/requests/task/{task_id}': {
      get: {
        ...
        parameters: [
          ...
          {
            required: false,
            schema: { title: 'Unresponded', type: 'boolean', default: true },
            name: 'unresponded',
            in: 'query',
          },
        ],
    ...
    '/rios': {
      get: {
        ...
        parameters: [
          { required: false, schema: { title: 'Id ', type: 'string' }, name: 'id_', in: 'query' },
          {
            required: false,
  ...
  components: {
    schemas: {
      Action: {
        title: 'Action',
        enum: ['waiting', 'cancelled', 'override', 'resume'],
        type: 'string',
        description: 'An enumeration.',
      },
      Activity: {
      ...
      AlertRequest: {
        ...
        properties: {
          ...
          unix_millis_alert_time: { title: 'Unix Millis Alert Time', type: 'integer' },
          title: { title: 'Title', type: 'string' },
          subtitle: { title: 'Subtitle', type: 'string' },
          message: { title: 'Message', type: 'string' },
          display: { title: 'Display', type: 'boolean' },
      ...
      AlertResponse: {
        ...
        properties: {
          id: { title: 'Id', type: 'string' },
          unix_millis_response_time: { title: 'Unix Millis Response Time', type: 'integer' },
      ...
      EventState: {
        ...
        properties: {
          ...
          status: { $ref: '#/components/schemas/api_server__models__rmf_api__task_state__Status' },
      ...
      FireAlarmTriggerState: {
        ...
        properties: {
          ...
          trigger: { title: 'Trigger', type: 'boolean' },
        },
      },
      FleetLog: {
        title: 'FleetLog',
      ...
      RobotState: {
        ...
        properties: {
          ...
          mutex_groups: {
            title: 'Mutex Groups',
            allOf: [{ $ref: '#/components/schemas/MutexGroups' }],
            description: 'Information about the mutex groups that this robot is interacting with',
          },
        },
      },
