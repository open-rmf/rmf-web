    ...
    schemas: {
      ...
      AffineImage: {
        properties: {
          ...
          x_offset: { type: 'number', title: 'X Offset', default: 0 },
          y_offset: { type: 'number', title: 'Y Offset', default: 0 },
          yaw: { type: 'number', title: 'Yaw', default: 0 },
          scale: { type: 'number', title: 'Scale', default: 0 },
          encoding: { type: 'string', title: 'Encoding', default: '' },
      ...
      DispenserState: {
        properties: {
          time: { allOf: [{ $ref: '#/components/schemas/Time' }], default: { sec: 0, nanosec: 0 } },
          guid: { type: 'string', title: 'Guid', default: '' },
          mode: {
            type: 'integer',
          ...
          seconds_remaining: { type: 'number', title: 'Seconds Remaining', default: 0 },
        },
        type: 'object',
        title: 'DispenserState',
      },
      Door: {
        properties: {
          name: { type: 'string', title: 'Name', default: '' },
          v1_x: { type: 'number', title: 'V1 X', default: 0 },
          v1_y: { type: 'number', title: 'V1 Y', default: 0 },
          v2_x: { type: 'number', title: 'V2 X', default: 0 },
          v2_y: { type: 'number', title: 'V2 Y', default: 0 },
          door_type: {
            type: 'integer',
            maximum: 255.0,
            minimum: 0.0,
          ...
          motion_range: { type: 'number', title: 'Motion Range', default: 0 },
          motion_direction: {
            type: 'integer',
            maximum: 2147483647.0,
            minimum: -2147483648.0,
      ...
      DoorState: {
        properties: {
          ...
          door_name: { type: 'string', title: 'Door Name', default: '' },
          current_mode: {
      ...
      GraphNode: {
        properties: {
          ...
          y: { type: 'number', title: 'Y', default: 0 },
          name: { type: 'string', title: 'Name', default: '' },
          params: {
            items: { $ref: '#/components/schemas/Param' },
            type: 'array',
      ...
      Level: {
        properties: {
          name: { type: 'string', title: 'Name', default: '' },
          elevation: { type: 'number', title: 'Elevation', default: 0 },
          images: {
      ...
      Lift: {
        properties: {
          name: { type: 'string', title: 'Name', default: '' },
          levels: { items: { type: 'string' }, type: 'array', title: 'Levels', default: [] },
          doors: {
            items: { $ref: '#/components/schemas/Door' },
            type: 'array',
            title: 'Doors',
          ...
          ref_x: { type: 'number', title: 'Ref X', default: 0 },
          ref_y: { type: 'number', title: 'Ref Y', default: 0 },
          ref_yaw: { type: 'number', title: 'Ref Yaw', default: 0 },
          width: { type: 'number', title: 'Width', default: 0 },
          depth: { type: 'number', title: 'Depth', default: 0 },
        },
        type: 'object',
        title: 'Lift',
      },
      ...
      LiftState: {
        properties: {
          ...
          lift_name: { type: 'string', title: 'Lift Name', default: '' },
          available_floors: {
            items: { type: 'string' },
            type: 'array',
            title: 'Available Floors',
          ...
          current_floor: { type: 'string', title: 'Current Floor', default: '' },
          destination_floor: { type: 'string', title: 'Destination Floor', default: '' },
          door_state: {
            type: 'integer',
            maximum: 255.0,
            minimum: 0.0,
      ...
      Param: {
        properties: {
          name: { type: 'string', title: 'Name', default: '' },
          type: { type: 'integer', maximum: 4294967295.0, minimum: 0.0, title: 'Type', default: 0 },
          value_int: {
            type: 'integer',
            maximum: 2147483647.0,
            minimum: -2147483648.0,
          ...
          value_float: { type: 'number', title: 'Value Float', default: 0 },
          value_string: { type: 'string', title: 'Value String', default: '' },
          value_bool: { type: 'boolean', title: 'Value Bool', default: false },
        },
        type: 'object',
        title: 'Param',
      },
      ...
      Place: {
        properties: {
          ...
          y: { type: 'number', title: 'Y', default: 0 },
          yaw: { type: 'number', title: 'Yaw', default: 0 },
          position_tolerance: { type: 'number', title: 'Position Tolerance', default: 0 },
          yaw_tolerance: { type: 'number', title: 'Yaw Tolerance', default: 0 },
        },
        type: 'object',
        title: 'Place',
      },
