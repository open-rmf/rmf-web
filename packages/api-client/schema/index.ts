      ...
      post: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: {
                $ref: '#/components/schemas/api_server.models.tortoise_models.alerts.AlertDetails.leaf',
              },
            },
          },
          required: true,
    ...
    schemas: {
      ...
      'api_server.models.tortoise_models.alerts.Alert.leaf': {
        ...
        properties: {
          ...
          created_on: { title: 'Created On', type: 'string', format: 'date-time' },
          acknowledged_by: {
      ...
      'api_server.models.tortoise_models.alerts.AlertDetails.leaf': {
        title: 'AlertDetails',
