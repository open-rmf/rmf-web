export default {
      ...
      post: {
        ...
        parameters: [
          ...
          },
          {
            ...
            in: 'query',
            required: true,
            schema: { $ref: '#/components/schemas/Tier-Input' },
          },
          {
            name: 'task_id',
            in: 'query',
  ...
  components: {
    schemas: {
      Action: { type: 'integer', enum: [0, 1, 2, 3], title: 'Action' },
      Activity: {
        properties: {
          category: {
            type: 'string',
      ...
      Alert: {
        properties: {
          ...
          category: {
            $ref: '#/components/schemas/api_server__models__tortoise_models__alerts__Alert__Category',
          },
          unix_millis_created_time: { type: 'integer', title: 'Unix Millis Created Time' },
          acknowledged_by: { type: 'string', title: 'Acknowledged By' },
          unix_millis_acknowledged_time: {
            type: 'integer',
            title: 'Unix Millis Acknowledged Time',
          },
      ...
      'Tier-Input': { type: 'integer', enum: [0, 1], title: 'Tier' },
      Time: {
        properties: {
      ...
      api_server__models__tortoise_models__alerts__Alert__Category: {
        type: 'string',
        enum: ['default', 'task', 'fleet', 'robot'],
        title: 'Category',
      },
    },
  },
