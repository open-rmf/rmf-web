export default {
  ...
  paths: {
    ...
    '/delivery_alerts': {
      get: {
        tags: ['DeliveryAlerts'],
        summary: 'Get Delivery Alerts',
        operationId: 'get_delivery_alerts_delivery_alerts_get',
        responses: {
          '200': {
            description: 'Successful Response',
            content: {
              'application/json': {
                schema: {
                  title: 'Response Get Delivery Alerts Delivery Alerts Get',
                  type: 'array',
                  items: {
      ...
      post: {
        tags: ['DeliveryAlerts'],
        summary: 'Create Delivery Alert',
        operationId: 'create_delivery_alert_delivery_alerts_post',
        parameters: [
          {
            required: true,
            schema: { title: 'Category', type: 'string' },
    ...
    '/delivery_alerts/{delivery_alert_id}': {
      get: {
        tags: ['DeliveryAlerts'],
        summary: 'Get Delivery Alert',
        operationId: 'get_delivery_alert_delivery_alerts__delivery_alert_id__get',
        parameters: [
          {
            required: true,
    ...
    '/delivery_alerts/{delivery_alert_id}/action': {
      post: {
        tags: ['DeliveryAlerts'],
        summary: 'Update Delivery Alert Action',
        operationId: 'update_delivery_alert_action_delivery_alerts__delivery_alert_id__action_post',
        parameters: [
          {
            required: true,
            schema: { title: 'Delivery Alert Id', type: 'string' },
    ...
    '/tasks/states': {
      get: {
        ...
        operationId: 'get_task_states_tasks_states_get',
        responses: {
          '200': {
            description: 'Successful Response',
            content: {
              'application/json': {
                schema: {
                  title: 'Response Get Task States Tasks States Get',
                  type: 'array',
                  items: { $ref: '#/components/schemas/TaskState' },
                },
              },
            ...
            content: {
              'application/json': {
                schema: {
                  ...
                  type: 'array',
                  items: {
                    $ref: '#/components/schemas/api_server.models.tortoise_models.tasks.TaskQueueEntry.leaf',
                  },
                },
              },
            },
  ...
  components: {
    schemas: {
      ...
      'api_server.models.tortoise_models.delivery_alerts.DeliveryAlert.leaf': {
        title: 'DeliveryAlert',
        required: ['id', 'category', 'tier', 'action'],
        type: 'object',
        properties: {
          id: { title: 'Id', maxLength: 255, type: 'string' },
          category: {
            ...
            type: 'string',
            description:
              'Missing: missing<br/>Wrong: wrong<br/>Obstructed: obstructed<br/>Cancelled: cancelled',
          },
          tier: {
            title: 'Tier',
            maxLength: 7,
          ...
          task_id: { title: 'Task Id', maxLength: 255, type: 'string', nullable: true },
          action: {
            title: 'Action',
            maxLength: 9,
            type: 'string',
            description:
              'Waiting: waiting<br/>Cancel: cancelled<br/>Override: override<br/>Resume: resume',
          },
          message: { title: 'Message', maxLength: 255, type: 'string', nullable: true },
        },
        additionalProperties: false,
        description: 'Custom alerts for custom delivery tasks',
      },
      ...
      'api_server.models.tortoise_models.tasks.TaskQueueEntry.leaf': {
        title: 'TaskQueueEntry',
        required: ['id_'],
        type: 'object',
        properties: {
