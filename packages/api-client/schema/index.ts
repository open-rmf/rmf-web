export default {
  ...
  paths: {
    ...
    '/teleoperation/{name}/video/join': {
      post: {
        ...
        operationId: 'join_video_room_teleoperation__name__video_join_post',
        parameters: [
          { required: true, schema: { title: 'Name', type: 'string' }, name: 'name', in: 'path' },
        ],
        requestBody: {
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/VideoRoomModel' } },
          },
          required: true,
        },
        responses: {
    ...
    '/teleoperation/{name}/video/leave': {
      post: {
        tags: ['Teleoperation'],
        summary: 'Leave Video Room',
        operationId: 'leave_video_room_teleoperation__name__video_leave_post',
        parameters: [
          { required: true, schema: { title: 'Name', type: 'string' }, name: 'name', in: 'path' },
        ],
        responses: {
    ...
    '/teleoperation/{name}/move': {
      post: {
        tags: ['Teleoperation'],
        summary: 'Move',
        operationId: 'move_teleoperation__name__move_post',
        parameters: [
          { required: true, schema: { title: 'Name', type: 'string' }, name: 'name', in: 'path' },
        ],
        requestBody: {
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/MotionObjectModel' } },
          },
          required: true,
        },
        responses: {
  ...
  components: {
    schemas: {
      ...
      MotionObjectModel: {
        title: 'MotionObjectModel',
        required: ['name', 'x_m', 'y_m', 'z_m', 'roll_deg', 'pitch_deg', 'yaw_deg'],
        type: 'object',
        properties: {
          name: { title: 'Name', type: 'string' },
          x_m: { title: 'X M', type: 'number' },
          y_m: { title: 'Y M', type: 'number' },
          z_m: { title: 'Z M', type: 'number' },
          roll_deg: { title: 'Roll Deg', type: 'number' },
          pitch_deg: { title: 'Pitch Deg', type: 'number' },
          yaw_deg: { title: 'Yaw Deg', type: 'number' },
        },
      },
      Param: {
        title: 'Param',
