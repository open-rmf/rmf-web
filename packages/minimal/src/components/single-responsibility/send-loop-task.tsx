      ...
      <Paper className={classes.paper}>
        <Grid container>
          ...
          <Grid item xs={12} className={classes.taskDetails}>
            ...
            <Typography variant="body1">Start: {task?.description.start_name}</Typography>
            <Typography variant="body1">End: {task?.description.finish_name}</Typography>
            <Typography variant="body1">Task Type: Loop</Typography>
          </Grid>
