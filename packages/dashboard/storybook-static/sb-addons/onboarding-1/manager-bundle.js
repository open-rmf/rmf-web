  ...
  (() => {
    ...
    function il(e, t, n) {
      ...
      var r = ol(e),
        ...
        l = i ? 'width' : 'height';
      return (
        (o[a] = t[a] + t[c] / 2 - r[c] / 2), n === s ? (o[s] = t[s] - r[l]) : (o[s] = t[ur(s)]), o
      );
    }
    function An(e, t) {
    ...
    function Ad(e, t) {
      if (sl(e.instance.modifiers, 'inner') || (e.flipped && e.placement === e.originalPlacement))
        return e;
      var n = Ho(
          e.instance.popper,
      ...
      var l = t.priority,
        ...
        d = {
          primary: function (p) {
            var h = u[p];
            return (
              u[p] < c[p] && !t.escapeWithReference && (h = Math.max(u[p], c[p])), Kt({}, p, h)
            );
          },
    ...
    function pn(e, t) {
      ...
      return (
        ...
        (p.offset +=
          (a = (i = t.spotlightPadding) != null ? i : l.spotlightPadding) != null ? a : 0),
    ...
    function Kp(e) {
      ...
      return (
        r &&
          ((N.primary = i ? j : D),
          x && (N.primary = O('span', null, N.primary, ' (', o + 1, '/', s, ')'))),
        v &&
          !i &&
          (N.skip = O(
            'button',
    ...
    function jm(e) {
      U(() => {
        let t = e;
        return (
          window.addEventListener('resize', t), () => void window.removeEventListener('resize', t)
        );
      }, [e]);
    }
    function Vm(e, t) {
    ...
    function oc(e, { layout: t, layoutId: n }) {
      return (
        Nt.has(e) || e.startsWith('origin') || ((t || n !== void 0) && (!!hr[e] || e === 'opacity'))
      );
    }
    ...
    function br({
      ...
      let E = y({ ...p, keyframes: r }),
        j;
      s === 'mirror' &&
        (j = y({ ...p, keyframes: [...r].reverse(), velocity: -(p.velocity || 0) }));
      let D = 'idle',
        P = null,
        N = null,
        te = null;
        ...
        ae = (J) => {
          ...
          if (i) {
            ...
            !$ && z >= 1 && ($ = 1),
              ...
              (q = Math.min(q, i + 1)),
              q % 2 &&
                (s === 'reverse' ? (($ = 1 - $), a && ($ -= a / Me)) : s === 'mirror' && (W = j)),
              (Y = wt(0, 1, $) * Me);
          }
      ...
      if (a)
        for (let s = 0; s < a; s++) {
          ...
          Array.isArray(l) && (u = l[0]),
            u === null &&
              (u =
                (o = (r = n[c]) !== null && r !== void 0 ? r : e.readValue(c)) !== null &&
                o !== void 0
                  ? o
                  : t[c]),
            u != null &&
        ...
        Array.from(e.variantChildren)
          ...
          .forEach((l, u) => {
            l.notify('AnimationStart', t),
              a.push(
                Mo(l, t, { ...i, delay: n + c(u) }).then(() => l.notify('AnimationComplete', t)),
              );
          }),
        Promise.all(a)
      );
      ...
      function a(c, l) {
        ...
        for (let v = 0; v < xv; v++) {
          ...
          (y.prevProp = w),
            ...
            P &&
              (!D || N) &&
              p.push(...te.map((ae) => ({ animation: ae, options: { type: b, ...c } })));
        }
        if (h.size) {
          let v = {};
          h.forEach((b) => {
    ...
    function Fv(e, t) {
      let n = 0.5,
        ...
        o = ke(t);
      return (
        o > r ? (n = Pn(t.min, t.max - r, e.min)) : r > o && (n = Pn(e.min, e.max - o, t.min)),
        wt(0, 1, n)
      );
    }
    function jv(e, t) {
    ...
    function o0(e, t = 0, n = 1, r = 0.5, o, i = e, a = e) {
      if (
        (Xe.test(t) && ((t = parseFloat(t)), (t = oe(a.min, a.max, t / 100) - a.min)),
        typeof t != 'number')
      )
        return;
    ...
    function s0(e, t) {
      return (
        e.x.min === t.x.min && e.x.max === t.x.max && e.y.min === t.y.min && e.y.max === t.y.max
      );
    }
    function iu(e, t) {
      return (
      ...
      return class {
        ...
        calcProjection() {
          ...
          this.projectionDelta ||
            ((this.projectionDelta = Yt()), (this.projectionDeltaWithTransform = Yt()));
        ...
        getLead() {
          ...
          return a
            ? ((i = this.getStack()) === null || i === void 0 ? void 0 : i.lead) || this
            : this;
        }
        getPrevLead() {
          var i;
        ...
        getProjectionStyles(i) {
          ...
          return (
            this.options.layoutId &&
              (c.pointerEvents = u === this ? ir(i?.pointerEvents) || '' : 'none'),
            c
          );
        }
        clearSnapshot() {
      ...
      return (
        U(() => {
          (async () => {
            try {
              let n =
                (await (await fetch('/project.json')).json())?.language === 'javascript' ? Pb : Cb;
              t({ data: n, error: null });
            } catch (n) {
              t({ data: null, error: n });
            }
                    ...
                    if (!l(H)) {
                      ...
                      return new v(
                        'Invalid ' +
                          ...
                          K +
                          '` of type ' +
                          ('`' + z + '` supplied to `' + W + '`, expected a single ReactElement.'),
                      );
                    }
                    return null;
                  }
                ...
                value: function () {
                  ...
                  return (
                    ...
                    g.createElement(
                      ...
                      g.createElement('div', { className: '__floater__body' }, l.content, l.arrow),
                    )
                  );
                },
              },
                    ...
                    if (d === 'center') this.setState({ status: X.IDLE });
                      ...
                      new ra(o, this.floaterRef, {
                        ...
                        onCreate: function (w) {
                          ...
                          c(w, 'floater'),
                            r._isMounted &&
                              r.setState({ currentPlacement: w.placement, status: X.IDLE }),
                            d !== w.placement &&
                              setTimeout(function () {
                                w.instance.update();
                              }, 1);
            ...
            constructor(e) {
              M(this, 'beaconPopper'),
                ...
                M(this, 'update', (o) => {
                  var i, a;
                  if (!Ip(o, ba))
                    throw new Error(`State is not valid. Valid keys: ${ba.join(', ')}`);
                  this.setState({
                    ...this.getNextState(
                      {
                        ...this.getState(),
          ...
          (Qh = se((e, t) => {
            ...
            return (
                  ...
                  return (
                    r &&
                      (u.layersWithOutsidePointerEventsDisabled.size === 0 &&
                        ((xa = h.body.style.pointerEvents), (h.body.style.pointerEvents = 'none')),
              ...
              U(
                () => () => {
                  d &&
                    (u.layers.delete(d), u.layersWithOutsidePointerEventsDisabled.delete(d), wa());
                },
                [d, u],
              ),
              U(() => {
...
`,
        ...
        (_t = So ? { passive: !1 } : !1),
          ...
          (Fl = function (e, t) {
            ...
            return (
              n[t] !== 'hidden' && !(n.overflowY === n.overflowX && !Df(e) && n[t] === 'visible')
            );
          }),
          (Lf = function (e) {
        ...
        (Yf = Bl),
            ...
            return (
              ...
              function () {
                a.forEach(function (d) {
                  ...
                  eo--,
                  eo ||
                    ((Ut = new WeakMap()), (Ut = new WeakMap()), (Kn = new WeakMap()), (Xn = {}));
              }
            );
          }),
          (Kf = function (e, t, n) {
          ...
          (Jf = (e) => {
            ...
            return O(
              ...
              Ye.map(r, (a) =>
                O(Cr, { present: n || i.open }, O(lf, { asChild: !0, container: o }, a)),
              ),
            );
          }),
          (Po = 'DialogOverlay'),
...
`;
        ...
        (Ha = (e, t) => {
          ...
          (we = {
            ...
            transform: (e) =>
              Fn(e) ? e : e.hasOwnProperty('red') ? Rt.transform(e) : Ht.transform(e),
          });
        (Dc = 'number'),
          (Lc = 'color'),
          (dy = 'var'),
        ...
        (eu = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
          ...
          (Gv = class {
            ...
            getAxisMotionValue(e) {
              ...
              return (
                n[t] || this.visualElement.getValue(e, (n.initial ? n.initial[e] : void 0) || 0)
              );
            }
            snapToCursor(e) {
              Ne((t) => {
                ...
                a = r.addEventListener('didUpdate', ({ delta: s, hasLayoutChanged: c }) => {
                  this.isDragging &&
                    ...
                    (Ne((l) => {
                      ...
                      u &&
                        ((this.originPoint[l] += s[l].translate), u.set(u.get() + s[l].translate));
                    }),
                    this.visualElement.render());
                });
              return () => {
          ...
          (Q0 = class {
            ...
            loadFeatures({ children: e, ...t }, n, r, o) {
              ...
              for (let s = 0; s < K0; s++) {
                ...
                d && (i = d),
                  l(t) &&
                    (!this.features[c] && u && (this.features[c] = new u(this)), p && (a = p));
              }
            ...
            addVariantChild(e) {
              ...
              if (t)
                return (
                  t.variantChildren && t.variantChildren.add(e), () => t.variantChildren.delete(e)
                );
            }
            addValue(e, t) {
            ...
            getValue(e, t) {
              ...
              return (
                n === void 0 && t !== void 0 && ((n = Qt(t, { owner: this })), this.addValue(e, n)),
                n
              );
            }
            readValue(e) {
            ...
            return g.createElement(
              ...
              t.map(({ toggle: i, snippet: a }, s) =>
                g.createElement(
                  ...
                  { key: s },
                  i === void 0 &&
                    g.createElement(an, { language: 'typescript', customStyle: o }, a),
                  i &&
                    !n &&
                        ...
                        i === 'args' &&
                          g.createElement(
                            ...
                            g.createElement(
                              ...
                              g.createElement(Le, { onClick: () => a('customStory') }, 'Next'),
                            ),
                          ),
                        i === 'customStory' &&
                          (f?.error
                            ...
                            : g.createElement(
                                ...
                                g.createElement(
                                  ...
                                  f?.data
                                    ? g.createElement(Le, { onClick: () => e() }, 'Go to story')
                                    : null,
                                ),
                              )),
                      ),
