...
function hi(t8, e) {
  ...
  return (pi(r, e.language) ?? pn(r, e.physicalFile) ?? pn(r, e.file) ?? (e.physicalFile, void 0))
    ?.parsers[0];
}
var Ne = hi,
  hn = 'inline',
...
function fi(t8) {
  return (
    t8.type === 'element' && !t8.hasExplicitNamespace && !['html', 'svg'].includes(t8.namespace)
  );
}
var de = fi,
  mi = (t8) => v(!1, t8, /^[\t\f\r ]*\n/g, ''),
      ...
      for (let s of n.children) {
        ...
        for (let u = 0; u < o.length; u++, i = a) {
          ...
          if (u % 2 === 0) {
            (a = i.moveBy(p.length)),
              p.length > 0 &&
                n.insertChildBefore(s, { type: 'text', value: p, sourceSpan: new f(i, a) });
            continue;
          }
...
function bs(t8) {
  return (
    wt(t8) || t8 === 62 || t8 === 60 || t8 === 47 || t8 === 39 || t8 === 34 || t8 === 61 || t8 === 0
  );
}
function so(t8) {
...
function Pr2(e) {
  ...
  function n(u, i, s) {
    ...
    if (u.type === b2)
      return ((a = s?.[i - 1]) == null ? void 0 : a.type) === A2 && s[i - 1].hard
        ? void 0
        : 'breakParent';
...
async function Qu(e, t8 = {}) {
  ...
  let n = et2({ plugins: e.plugins, showDeprecated: !0 }).options,
    o = {
      ...cn2,
      ...Object.fromEntries(
        n.filter((f2) => f2.default !== void 0).map((f2) => [f2.name, f2.default]),
      ),
    },
  ...
  Vt2 = class {
    ...
    match(...t8) {
      ...
      for (let u of t8) {
        ...
        let i = null;
        if (
          (typeof n == 'number' && ((i = n), (n = this.stack[r--]), (o = this.stack[r--])),
          u && !u(o, n, i))
        )
          return !1;
...
async function Xn2(e, t8, r) {
  ...
  return (
    r &&
      (r.preprocessForPrint && (u.ast = await Ht2(u.ast, o)), r.massage && (u.ast = fn2(u.ast, o))),
    u
  );
}
