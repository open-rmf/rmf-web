  ...
  '../../node_modules/lodash/_listCacheSet.js'(exports, module) {
    ...
    function listCacheSet2(key2, value2) {
      var data = this.__data__,
        index3 = assocIndexOf2(data, key2);
      return (
        index3 < 0 ? (++this.size, data.push([key2, value2])) : (data[index3][1] = value2), this
      );
    }
...
function createBrowserHistory(options2) {
  ...
  function getIndexAndLocation() {
    ...
    return [
      state.idx,
      readOnly({ pathname, search, hash, state: state.usr || null, key: state.key || 'default' }),
    ];
  }
  ...
  index3 == null &&
    ((index3 = 0),
    globalHistory.replaceState(_extends2({}, globalHistory.state, { idx: index3 }), ''));
  ...
  function allowTx(action2, location22, retry) {
    return (
      !blockers.length || (blockers.call({ action: action2, location: location22, retry }), !1)
    );
  }
...
function useHref(to) {
  useInRouterContext() ||
    invariant(!1, 'useHref() may be used only in the context of a <Router> component.');
...
function useLocation() {
  return (
    useInRouterContext() ||
      invariant(!1, 'useLocation() may be used only in the context of a <Router> component.'),
    (0, import_react.useContext)(LocationContext).location
  );
}
function useNavigate() {
  useInRouterContext() ||
    invariant(!1, 'useNavigate() may be used only in the context of a <Router> component.');
  let { basename, navigator: navigator3 } = (0, import_react.useContext)(NavigationContext),
  ...
  if (foo && bar && (ctor = foo.constructor) === bar.constructor) {
    ...
    if (ctor === Set) {
      ...
      for (len of foo)
        if (
          ((tmp = len),
          (tmp && typeof tmp == 'object' && ((tmp = find2(bar, tmp)), !tmp)) || !bar.has(tmp))
        )
          return !1;
      return !0;
    }
...
var React33 = __toESM(require_react(), 1),
  iconList = [
    ...
    {
      name: 'Git',
      icons: ['RepoIcon', 'CommitIcon', 'BranchIcon', 'PullRequestIcon', 'MergeIcon'],
    },
...
var __create3 = Object.create,
    ...
    '../../node_modules/semver/internal/identifiers.js'(exports, module) {
      var numeric = /^[0-9]+$/,
        compareIdentifiers = (a, b2) => {
          ...
          return (
            anum && bnum && ((a = +a), (b2 = +b2)),
            a === b2 ? 0 : anum && !bnum ? -1 : bnum && !anum ? 1 : a < b2 ? -1 : 1
          );
        },
      ...
      var debug = require_debug(),
        ...
        SemVer = class _SemVer {
          constructor(version2, options2) {
            ...
            let m = version2.trim().match(options2.loose ? re[t.LOOSE] : re[t.FULL]);
  ...
  require_compare = __commonJS4({
    '../../node_modules/semver/functions/compare.js'(exports, module) {
      var SemVer = require_semver(),
        compare = (a, b2, loose) => new SemVer(a, loose).compare(new SemVer(b2, loose));
  ...
  require_sort = __commonJS4({
    '../../node_modules/semver/functions/sort.js'(exports, module) {
      var compareBuild = require_compare_build(),
        sort = (list, loose) => list.sort((a, b2) => compareBuild(a, b2, loose));
      module.exports = sort;
    },
  }),
  require_rsort = __commonJS4({
    '../../node_modules/semver/functions/rsort.js'(exports, module) {
      var compareBuild = require_compare_build(),
        rsort = (list, loose) => list.sort((a, b2) => compareBuild(b2, a, loose));
        ...
        coerce = (version2, options2) => {
          ...
          if (!options2.rtl) match = version2.match(re[t.COERCE]);
            ...
            for (
              ...
              (!match || next.index + next[0].length !== match.index + match[0].length) &&
                (match = next),
          ...
          return match === null
            ? null
            : parse2(`${match[2]}.${match[3] || '0'}.${match[4] || '0'}`, options2);
        };
          ...
          for (let c2 of dom) {
            if (
              ...
              if (
                ...
                if (((higher = higherGT(gt, c2, options2)), higher === c2 && higher !== gt))
                  return !1;
...
var Store = class {
    ...
    async setState(inputPatch, cbOrOptions, inputOptions) {
      ...
      if (persistence !== 'none') {
        let storage =
          persistence === 'session' ? import_store2.default.session : import_store2.default.local;
...
var init2 = ({ provider, store: store2, fullAPI }) => {
    let api = {
      ...
      getAddonState: (addonId) =>
        store2.getState().addons[addonId] || globalThis?.STORYBOOK_ADDON_STATE[addonId],
    };
    return {
      api,
      state: {
...
var init3 = ({ provider }) => ({
    api: {
      ...
      on: (type, handler) => (
        provider.channel?.on(type, handler), () => provider.channel?.off(type, handler)
      ),
...
var parseUrl = (url) => {
    ...
    return (
      credentials &&
        ((cleanUrl = url.replace(`${credentials}@`, '')), (authorization = btoa(`${credentials}`))),
        ...
        checkRef: async (ref) => {
          ...
          let [indexResult, storiesResult] = await Promise.all(
            ['index.json', 'stories.json'].map(async (file) =>
              handleRequest(
                fetch(`${urlParseResult.url}/${file}${query}`, { headers, credentials }),
              ),
            ),
          );
      ...
      selectStory: (titleOrId = void 0, name2 = void 0, options2 = {}) => {
        ...
        if (hash)
          if (name2)
            ...
            let entry = titleOrId ? hash[titleOrId] || hash[L(titleOrId)] : hash[kindSlug];
    ...
    provider.channel?.on(STORY_SPECIFIED, function ({ storyId, viewMode }) {
      ...
      provider.channel?.on(SET_CONFIG, () => {
        ...
        config2?.sidebar?.filters &&
          store2.setState({
            filters: { ...store2.getState().filters, ...config2?.sidebar?.filters },
          });
      });
...
var { navigator } = scope,
  isMacLike = () =>
    navigator && navigator.platform ? !!navigator.platform.match(/(Mac|iPhone|iPod|iPad)/i) : !1,
    ...
    let { dismissedVersionNotification } = store2.getState(),
      ...
      api = {
        ...
        getDocsUrl: ({ subpath, versioned, renderer }) => {
          ...
          if (
            (subpath && (url += `${subpath}/`), renderer && typeof scope.STORYBOOK_RENDERER < 'u')
          ) {
  ...
  init12 = ({ fullAPI, store: store2, provider }) => {
    ...
    function getLatestWhatsNewPost() {
      return (
        ...
        new Promise((resolve) =>
          provider.channel?.once(RESULT_WHATS_NEW_DATA, ({ data }) => resolve(data)),
        )
      );
    }
  ...
  ManagerProvider = class extends import_react2.Component {
    constructor(props) {
      ...
      let state = initial_state_default(this.state, ...this.modules.map((m) => m.state)),
        api = Object.assign(this.api, { navigate }, ...this.modules.map((m) => m.api));
...
function useStorybookState() {
  ...
  return {
    ...
    get storiesFailed() {
      return (
        deprecate('state.storiesFailed is deprecated, please use state.indexError'), this.indexError
      );
    },
  };
}
...
function rgb(value2, green, blue) {
  ...
  if (typeof value2 == 'object' && green === void 0 && blue === void 0)
    return reduceHexValue$1(
      '#' + numberToHex(value2.red) + numberToHex(value2.green) + numberToHex(value2.blue),
    );
...
var curriedTransparentize = curry(transparentize),
  ...
  components = {
    ...
    pre: (props) =>
      import_react3.default.createElement(Pre, { ...nameSpaceClassNames(props, 'pre') }),
    ...
    table: (props) =>
      import_react3.default.createElement(Table, { ...nameSpaceClassNames(props, 'table') }),
    img: (props) =>
      import_react3.default.createElement(Img, { ...nameSpaceClassNames(props, 'img') }),
    div: (props) =>
      import_react3.default.createElement(Div, { ...nameSpaceClassNames(props, 'div') }),
    span: (props) =>
      import_react3.default.createElement(Span, { ...nameSpaceClassNames(props, 'span') }),
    ...
    code: (props) =>
      import_react3.default.createElement(Code, { ...nameSpaceClassNames(props, 'code') }),
  ...
  LazySyntaxHighlighterWithFormatter = (0, import_react3.lazy)(async () => {
    ...
    return (
      ...
      {
        default: (props) =>
          import_react3.default.createElement(SyntaxHighlighter3, { ...props, formatter }),
      }
    );
  }),
...
var useWindowResizeListener = function (listener) {
  ...
  LazyWithTooltip = (0, import_react3.lazy)(() =>
    import('./WithTooltip-Y7J54OF7-3AIPQNGM.js').then((mod) => ({ default: mod.WithTooltip })),
  ),
  WithTooltip = (props) =>
    import_react3.default.createElement(
      import_react3.Suspense,
  ...
  LazyWithTooltipPure = (0, import_react3.lazy)(() =>
    import('./WithTooltip-Y7J54OF7-3AIPQNGM.js').then((mod) => ({ default: mod.WithTooltipPure })),
  ),
...
var Note = newStyled.div(({ theme }) => ({
  ...
  Title3 = newStyled(({ active, loading, disabled, ...rest }) =>
    ...
    ({ disabled, theme }) =>
      disabled ? { color: curriedTransparentize$1(0.7, theme.color.defaultText) } : {},
  ),
    ...
    return import_react3.default.createElement(
      ...
      title || center
        ? import_react3.default.createElement(
            ...
            title &&
              import_react3.default.createElement(Title3, { ...commonProps, loading }, title),
...
function ForwardRefFunction({ children, ...rest }, ref) {
  ...
  if (isLink(o))
    return import_react3.default.createElement('a', { ref: o.ref, ...o.props }, children);
  if (isButton(o))
    return import_react3.default.createElement(
      'button',
...
var UnstyledBar = ({ children, className, scrollable }) =>
  ...
  Bar = newStyled(UnstyledBar)(
    ...
    ({ theme, border = !1 }) =>
      border
        ? { boxShadow: `${theme.appBorderColor}  0 -1px 0 0 inset`, background: theme.barBg }
        : {},
  );
Bar.displayName = 'Bar';
  ...
  Tabs = (0, import_react3.memo)(
    ({
      ...
      let idList = childrenToList(children)
        ...
        EmptyContent =
          emptyState ??
          import_react3.default.createElement(EmptyTabContent, { title: 'Nothing found' });
      ...
      (acc, item, index3) =>
        item
          ? import_react3.default.createElement(
              ...
              acc,
              index3 > 0
                ? import_react3.default.createElement(Separator, { key: `s-${index3}` })
                : null,
              item.render() || item,
            )
          : acc,
