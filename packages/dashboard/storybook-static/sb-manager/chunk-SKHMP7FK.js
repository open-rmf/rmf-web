  ...
  '../../node_modules/object-assign/index.js'(exports, module) {
    ...
    function shouldUseNative() {
      try {
        ...
        for (var test2 = {}, i3 = 0; i3 < 10; i3++) test2['_' + String.fromCharCode(i3)] = i3;
          ...
          for (var from, to = toObject(target), symbols, s2 = 1; s2 < arguments.length; s2++) {
            ...
            if (getOwnPropertySymbols) {
              ...
              for (var i3 = 0; i3 < symbols.length; i3++)
                propIsEnumerable.call(from, symbols[i3]) && (to[symbols[i3]] = from[symbols[i3]]);
            }
          }
          return to;
        };
  ...
  '../../node_modules/prop-types/factoryWithTypeCheckers.js'(exports, module) {
    ...
    module.exports = function (isValidElement, throwOnDirectAccess) {
      ...
      function createEnumTypeChecker(expectedValues) {
        ...
        function validate(props, propName, componentName, location, propFullName) {
          for (var propValue = props[propName], i3 = 0; i3 < expectedValues.length; i3++)
      ...
      function createUnionTypeChecker(arrayOfTypeCheckers) {
        ...
        function validate(props, propName, componentName, location, propFullName) {
          for (var expectedTypes = [], i4 = 0; i4 < arrayOfTypeCheckers.length; i4++) {
    ...
    function equal(a2, b2) {
      ...
      if (a2 && b2 && typeof a2 == 'object' && typeof b2 == 'object') {
        ...
        if (hasMap && a2 instanceof Map && b2 instanceof Map) {
          ...
          for (it = a2.entries(); !(i3 = it.next()).done; ) if (!b2.has(i3.value[0])) return !1;
        ...
        for (i3 = length; i3-- !== 0; )
          if (
            !((keys[i3] === '_owner' || keys[i3] === '__v' || keys[i3] === '__o') && a2.$$typeof) &&
    ...
    (function (e3, t3) {
      ...
      return (function (e3) {
        ...
        function r3(n3) {
          ...
          return e3[n3].call(o2.exports, o2, o2.exports, r3), (o2.l = !0), o2.exports;
        }
        return (
          (r3.m = e3),
          (r3.c = t3),
                  ...
                  },
                  {
                    ...
                    value: function (e5) {
                      if (
                        ...
                        for (
                          var o3 = null, i4 = null, a4 = 0, s3 = 0, c3 = e5.length;
                          s3 < c3;
                          s3 += 1
                        ) {
                          var h3 = e5[s3];
...
Search pattern: "`.concat(e5, '"'),
                      ...
                      return (
                        ...
                        t5.limit && typeof t5.limit == 'number' && (i4 = i4.slice(0, t5.limit)),
                        this._format(i4)
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (this.options.tokenize)
                        for (
                          var r5 = e5.split(this.options.tokenSeparator), n4 = 0, o3 = r5.length;
                          n4 < o3;
                          n4 += 1
                        )
...
Key: `.concat(n4 === '' ? '--' : n4),
                            ...
                            var v3 = f2.search(o4);
                            if (
                              (r5._log('Full text: "'.concat(o4, '", score: ').concat(v3.score)),
                              r5.options.tokenize)
                            ) {
                              for (
...
Pattern: "`.concat(S2.pattern, '"'),
                            ...
                            var j2 =
                              !r5.options.tokenize || !r5.options.matchAllTokens || l3 >= u2.length;
                            if (
                              (r5._log(
                                `
Check Matches: `.concat(j2),
                              ...
                              I2
                                ? I2.output.push(P2)
                                : ((p2[a5] = { item: i5, output: [P2] }), g2.push(p2[a5]));
                            }
                          } else if (c2(o4))
...
`);
                      for (
                        ...
                        for (
                          var i4 = e5[n4], a4 = i4.output, s3 = a4.length, c3 = 1, h3 = 0;
                          h3 < s3;
                          h3 += 1
                        ) {
                          var l2 = a4[h3],
                            u2 = l2.key,
                            f2 = r5 ? t5[u2] : 1,
                            v2 = l2.score === 0 && t5 && t5[u2] > 0 ? Number.EPSILON : l2.score;
                          c3 *= Math.pow(v2, f2);
                        }
...
`,
                ...
                (r4 = [
                  {
                    ...
                    value: function (e5) {
                      ...
                      if (this.pattern.length > c2) return o2(e5, this.pattern, h2);
                      var l2 = this.options,
                        u2 = l2.location,
                        f2 = l2.distance,
                        v2 = l2.threshold,
        ...
        function (e3, t3) {
          e3.exports = function () {
            for (
              ...
              s2 && n3 === -1
                ? (n3 = i3)
                : s2 || n3 === -1 || ((o2 = i3 - 1) - n3 + 1 >= t4 && r3.push([n3, o2]), (n3 = -1));
            }
        ...
        function (e3, t3) {
          e3.exports = function (e4) {
            ...
            for (var o2 = 0; o2 < r3; o2 += 1) t4[e4.charAt(o2)] |= 1 << (r3 - o2 - 1);
            return t4;
          };
        },
        function (e3, t3) {
                ...
                (function e5(t5, s2) {
                  if (s2) {
                    var c2 = s2.indexOf('.'),
                      h2 = s2,
                      l2 = null;
                    c2 !== -1 && ((h2 = s2.slice(0, c2)), (l2 = s2.slice(c2 + 1)));
                    var u2 = t5[h2];
                    if (u2 != null)
                      if (l2 || (!o2(u2) && !i3(u2)))
                        if (r3(u2))
                          for (var f2 = 0, v2 = u2.length; f2 < v2; f2 += 1) e5(u2[f2], l2);
                        else l2 && e5(u2, l2);
                      else a2.push(n3(u2));
                  } else a2.push(t5);
                })(e4, t4),
...
function u(t3, e3) {
  ...
  var r3,
    ...
    i3 = {},
    o2 = Object.keys(t3);
  for (n3 = 0; n3 < o2.length; n3++) e3.indexOf((r3 = o2[n3])) >= 0 || (i3[r3] = t3[r3]);
  return i3;
}
var l = {
    BASE: 'base',
    ...
    return r3
      ...
      .reduce(function (t4, r4) {
        ...
        r4.filter(function (t5) {
          ...
          return (
            n3[r5] || (n3[r5] = {}), i3[r5] || (i3[r5] = {}), !n3[r5][u3] && ((i3[r5][u3] = !0), !0)
          );
        })
          .reverse()
          .forEach(function (e4) {
      ...
      return (
        Object.keys(r4).forEach(function (t3) {
          ...
          e4 === 'innerHTML' || e4 === 'cssText'
            ? (o2.dangerouslySetInnerHTML = { __html: r4.innerHTML || r4.cssText })
            : (o2[e4] = r4[t3]);
        }),
              ...
              return e4.reduce(function (e5, n4) {
                var i3 = Object.keys(n4)
                    ...
                    .reduce(function (t4, e6) {
                      var i4 = n4[e6] === void 0 ? e6 : e6 + '="' + w(n4[e6], r4) + '"';
                      return t4 ? t4 + ' ' + i4 : i4;
                    }, ''),
                  o2 = n4.innerHTML || n4.cssText || '',
                  a2 = P.indexOf(t3) === -1;
                return (
                  e5 + '<' + t3 + ' data-rh="true" ' + i3 + (a2 ? '/>' : '>' + o2 + '</' + t3 + '>')
                );
              }, '');
            })(e3, r3, n3);
          },
  ...
  q = (function (e3) {
    function r3(t3) {
      var n3;
      return (
        ((n3 = e3.call(this, t3) || this).helmetData = new N(n3.props.context, r3.canUseDOM)), n3
      );
    }
    return (
      s(r3, e3),
  ...
  B = function (t3, e3) {
    ...
    if (r3) {
      for (
        ...
        var c2 = a2[s2],
          u2 = e3[c2] || '';
        r3.getAttribute(c2) !== u2 && r3.setAttribute(c2, u2), i3.indexOf(c2) === -1 && i3.push(c2);
          ...
          import_react.default.Children.forEach(e4, function (t3) {
            if (t3 && t3.props) {
              var e5 = t3.props,
                ...
                c2 = t3.type;
              switch (
                (typeof c2 == 'symbol' ? (c2 = c2.toString()) : n3.warnOnInvalidChildren(t3, o3),
                c2)
              ) {
                case l.FRAGMENT:
    ...
    return isMobile
      ...
      : import_react5.default.createElement(
          WithTooltip,
          {
            ...
            tooltip: ({ onHide }) =>
              import_react5.default.createElement(SidebarMenuList, { onHide, menu }),
...
var get = (0, import_memoizerific.default)(1e3)((id, dataset) => dataset[id]),
  ...
  getDescendantIds = (0, import_memoizerific.default)(1e3)((data, id, skipLeafs) => {
    let entry = data[id];
    return (entry.type === 'story' || entry.type === 'docs' ? [] : entry.children).reduce(
      (acc, childId) => {
...
var SmallIcons = newStyled(CircleIcon)({ '&&&': { width: 6, height: 6 } }),
  ...
  statusMapping = {
    ...
    error: [
      import_react14.default.createElement(SmallIcons, { key: 'icon', style: { color: 'red' } }),
      'brown',
    ],
  },
        ...
        () =>
          singleStoryComponentIds.reduce(
            (acc, id) => {
              ...
              return (
                (acc[childId] = { ...data[childId], name, parent, depth: data[childId].depth - 1 }),
                acc
              );
            },
            { ...data },
    ...
    return import_react16.default.createElement(
      ...
      isExpanded &&
        import_react16.default.createElement(
          ...
          state === 'auth' &&
            import_react16.default.createElement(AuthBlock, { id: refId, loginUrl }),
          state === 'error' &&
            import_react16.default.createElement(ErrorBlock, { error: indexError }),
...
var i2 = function (e3, i3) {
  ...
  for (
    var a2, c2, g2 = document.scrollingElement || document.documentElement, p2 = [], m2 = e3;
    t2(m2) && s2(m2);

  ) {
    if ((m2 = (c2 = (a2 = m2).parentElement) == null ? a2.getRootNode().host || null : c2) === g2) {
      p2.push(m2);
      break;
    }
    (m2 != null && m2 === document.body && n2(m2) && !n2(document.documentElement)) ||
  ...
  for (
    var w2 = o2.visualViewport ? o2.visualViewport.width : innerWidth,
      ...
      x2 = b2.bottom,
      I2 = b2.left,
      C2 = d2 === 'start' || d2 === 'nearest' ? M2 : d2 === 'end' ? x2 : M2 + y2 / 2,
    ...
    var N2 = getComputedStyle(B2),
      ...
      P2 = 'offsetHeight' in B2 ? B2.offsetHeight - B2.clientHeight - z2 - F2 : 0,
      Q = 'offsetWidth' in B2 ? (B2.offsetWidth === 0 ? 0 : X / B2.offsetWidth) : 0,
      U2 = 'offsetHeight' in B2 ? (B2.offsetHeight === 0 ? 0 : O2 / B2.offsetHeight) : 0;
    if (g2 === B2)
      (G2 =
        d2 === 'start'
          ? C2
      ...
      var Z = B2.scrollLeft,
        $ = B2.scrollTop;
      (C2 += $ - (G2 = Math.max(0, Math.min($ + G2 / U2, B2.scrollHeight - O2 / U2 + P2)))),
        (R2 += Z - (J = Math.max(0, Math.min(Z + J / Q, B2.scrollWidth - X / Q + K2))));
    }
...
function scrollIntoView2(node, menuNode) {
  if (!node) return;
  i2(node, { boundary: menuNode, block: 'nearest', scrollMode: 'if-needed' }).forEach((_ref) => {
...
function getState(state, props) {
  return Object.keys(state).reduce(
    (prevState, key) => (
      (prevState[key] = isControlledProp(props, key) ? props[key] : state[key]), prevState
    ),
    {},
  );
}
...
function getNextNonDisabledIndex(moveAmount, baseIndex, itemCount, getItemNodeFromIndex, circular) {
  ...
  return circular
    ? moveAmount > 0
      ...
      : getNextNonDisabledIndex(-1, itemCount - 1, itemCount, getItemNodeFromIndex, !1)
    : -1;
}
  ...
  Downshift = (() => {
    class Downshift2 extends import_react20.Component {
      constructor(_props) {
        ...
        super(_props),
          ...
          (this.internalSetTimeout = (fn, time) => {
            let id = setTimeout(() => {
              (this.timeoutIds = this.timeoutIds.filter((i3) => i3 !== id)), fn();
            }, time);
          ...
          (this.selectHighlightedItem = (otherStateToSet, cb) =>
            this.selectItemAtIndex(this.getState().highlightedIndex, otherStateToSet, cb)),
          ...
          (this.getRootProps = function (_temp, _temp2) {
            let { refKey = 'ref', ref, ...rest } = _temp === void 0 ? {} : _temp,
          ...
          (this.keyDownHandlers = {
            ArrowDown(event) {
              if ((event.preventDefault(), this.getState().isOpen)) {
                ...
                this.internalSetState({ isOpen: !0, type: keyDownArrowDown }, () => {
                  ...
                  if (itemCount > 0) {
                    ...
                    this.setHighlightedIndex(nextHighlightedIndex, { type: keyDownArrowDown });
                  }
                });
            },
            ArrowUp(event) {
              if ((event.preventDefault(), this.getState().isOpen)) {
                ...
                this.internalSetState({ isOpen: !0, type: keyDownArrowUp }, () => {
                  let itemCount = this.getItemCount();
                  if (itemCount > 0) {
                    let { highlightedIndex } = this.getState(),
                      nextHighlightedIndex = getNextWrappingIndex(
                    ...
                    this.setHighlightedIndex(nextHighlightedIndex, { type: keyDownArrowUp });
                  }
                });
            },
            Enter(event) {
          ...
          (this.buttonHandleClick = (event) => {
            event.preventDefault(),
              ...
              this.internalSetTimeout(() => this.toggleMenu({ type: clickButton }));
          }),
          ...
          (this.getInputProps = function (_temp4) {
            let { onKeyDown, onBlur, onChange, onInput, onChangeText, ...rest } =
          ...
          (this.inputHandleBlur = () => {
            this.internalSetTimeout(() => {
              ...
              !this.isMouseDown && !downshiftButtonIsActive && this.reset({ type: blurInput });
            });
          }),
          (this.menuRef = (node) => {
            this._menuNode = node;
          ...
          (this.getMenuProps = function (_temp5, _temp6) {
            let { refKey = 'ref', ref, ...props } = _temp5 === void 0 ? {} : _temp5,
      ...
      getState(stateToMerge) {
        return (
          stateToMerge === void 0 && (stateToMerge = this.state), getState(stateToMerge, this.props)
        );
      }
      getItemCount() {
      ...
      scrollHighlightedItemIntoView() {
        {
          let node = this.getItemNodeFromIndex(this.getState().highlightedIndex);
      ...
      getStateAndHelpers() {
        let { highlightedIndex, inputValue, selectedItem, isOpen } = this.getState(),
...
function callOnChangeProps(action, state, newState) {
  ...
  Object.keys(state).forEach((key) => {
    ...
    props.onStateChange && Object.keys(changes).length && props.onStateChange({ type, ...changes });
}
...
function getItemIndex(index, item, items) {
  return index !== void 0 ? index : items.length === 0 ? -1 : items.indexOf(item);
}
...
function useEnhancedReducer(reducer, initialState, props) {
  let prevStateRef = (0, import_react20.useRef)(),
    ...
    [state, dispatch] = (0, import_react20.useReducer)(enhancedReducer, initialState),
...
function getHighlightedIndexOnOpen(props, state, offset, getItemNodeFromIndex) {
  ...
  return items.length === 0
    ? -1
    : initialHighlightedIndex !== void 0 && highlightedIndex === initialHighlightedIndex
...
function useMouseAndTouchTracker(isOpen, downshiftElementRefs, environment, handleBlur) {
  let mouseAndTouchTrackersRef = (0, import_react20.useRef)({ isMouseDown: !1, isTouchMove: !1 });
  return (
    (0, import_react20.useEffect)(() => {
      let onMouseDown = () => {
...
useGetterPropsCalledChecker = function () {
  ...
  return (
    ...
    (0, import_react20.useCallback)((propKey, suppressRefError, refKey, elementRef) => {
  ...
  switch (type) {
    ...
    case ToggleButtonKeyDownCharacter:
      {
        ...
        changes = { inputValue, ...(itemIndex >= 0 && { selectedItem: props.items[itemIndex] }) };
      }
      break;
    ...
    case MenuKeyDownSpaceButton:
      changes = {
        isOpen: getDefaultValue$1(props, 'isOpen'),
        highlightedIndex: getDefaultValue$1(props, 'highlightedIndex'),
        ...(state.highlightedIndex >= 0 && { selectedItem: props.items[state.highlightedIndex] }),
      };
      break;
    ...
    case MenuKeyDownCharacter:
      {
        ...
        changes = { inputValue, ...(highlightedIndex >= 0 && { highlightedIndex }) };
      }
      break;
...
function useSelect(userProps) {
  ...
  let props = { ...defaultProps$2, ...userProps },
    ...
    [state, dispatch] = useControlledReducer$1(downshiftSelectReducer, initialState, props),
  ...
  (0, import_react20.useEffect)(
    ...
    useControlPropsValidator({ isInitialMount: isInitialMountRef.current, props, state }),
    (0, import_react20.useEffect)(() => {
      if (isInitialMountRef.current) {
        (initialIsOpen || defaultIsOpen || isOpen) && menuRef.current && menuRef.current.focus();
        return;
      }
      if (isOpen) {
    ...
    (0, import_react20.useEffect)(() => {
      isInitialMountRef.current || (previousResultCountRef.current = items.length);
    });
  ...
  let toggleButtonKeyDownHandlers = (0, import_react20.useMemo)(
    ...
    menuKeyDownHandlers = (0, import_react20.useMemo)(
      () => ({
        ...
        ArrowUp(event) {
          event.preventDefault(),
            dispatch({ type: MenuKeyDownArrowUp, getItemNodeFromIndex, shiftKey: event.shiftKey });
        },
        Home(event) {
          event.preventDefault(), dispatch({ type: MenuKeyDownHome, getItemNodeFromIndex });
        },
        End(event) {
          event.preventDefault(), dispatch({ type: MenuKeyDownEnd, getItemNodeFromIndex });
        },
        Escape() {
          ...
          menuHandleKeyDown = (event) => {
            ...
            key && menuKeyDownHandlers[key]
              ...
              : isAcceptedCharacterKey(key) &&
                dispatch({ type: MenuKeyDownCharacter, key, getItemNodeFromIndex });
          },
          menuHandleBlur = () => {
            ...
            !mouseAndTouchTrackersRef.current.isMouseDown && dispatch({ type: MenuBlur });
          },
    ...
    getToggleButtonProps = (0, import_react20.useCallback)(
      function (_temp3, _temp4) {
        let { onClick, onKeyDown, refKey = 'ref', ref, ...rest } = _temp3 === void 0 ? {} : _temp3,
          ...
          toggleButtonHandleKeyDown = (event) => {
            ...
            key && toggleButtonKeyDownHandlers[key]
              ...
              : isAcceptedCharacterKey(key) &&
                dispatch({ type: ToggleButtonKeyDownCharacter, key, getItemNodeFromIndex });
          },
          toggleProps = {
    ...
    getItemProps = (0, import_react20.useCallback)(
      function (_temp5) {
        ...
        if (itemIndex < 0) throw new Error('Pass either item or item index in getItemProps!');
        let itemProps = {
          disabled,
          role: 'option',
          ...
          [refKey]: handleRefs(ref, (itemNode) => {
            itemNode && (itemRefs.current[elementIds.getItemId(itemIndex)] = itemNode);
          }),
          ...rest,
        };
        return (
...
function useCombobox(userProps) {
  ...
  let props = { ...defaultProps$1, ...userProps },
    ...
    [state, dispatch] = useControlledReducer(downshiftUseComboboxReducer, initialState, props),
    { isOpen, highlightedIndex, selectedItem, inputValue } = state,
    menuRef = (0, import_react20.useRef)(null),
    itemRefs = (0, import_react20.useRef)({}),
  ...
  useControlPropsValidator({ isInitialMount: isInitialMountRef.current, props, state }),
    (0, import_react20.useEffect)(() => {
      (initialIsOpen || defaultIsOpen || isOpen) && inputRef.current && inputRef.current.focus();
    }, []),
    (0, import_react20.useEffect)(() => {
      isInitialMountRef.current || (previousResultCountRef.current = items.length);
    });
  ...
  let inputKeyDownHandlers = (0, import_react20.useMemo)(
      () => ({
        ...
        ArrowUp(event) {
          event.preventDefault(),
            dispatch({ type: InputKeyDownArrowUp, shiftKey: event.shiftKey, getItemNodeFromIndex });
        },
        Home(event) {
          latest.current.state.isOpen &&
            (event.preventDefault(), dispatch({ type: InputKeyDownHome, getItemNodeFromIndex }));
        },
        End(event) {
          latest.current.state.isOpen &&
            (event.preventDefault(), dispatch({ type: InputKeyDownEnd, getItemNodeFromIndex }));
        },
        Escape(event) {
        ...
        Enter(event) {
          ...
          !latestState.isOpen ||
            ...
            event.which === 229 ||
            (event.preventDefault(), dispatch({ type: InputKeyDownEnter, getItemNodeFromIndex }));
        },
      }),
      [dispatch, latest, getItemNodeFromIndex],
    ),
    getLabelProps = (0, import_react20.useCallback)(
      (labelProps) => ({ id: elementIds.labelId, htmlFor: elementIds.inputId, ...labelProps }),
      [elementIds],
    ),
    getMenuProps = (0, import_react20.useCallback)(
      function (_temp, _temp2) {
        let { onMouseLeave, refKey = 'ref', ref, ...rest } = _temp === void 0 ? {} : _temp,
          { suppressRefError = !1 } = _temp2 === void 0 ? {} : _temp2;
        return (
          setGetterPropCallInfo('getMenuProps', suppressRefError, refKey, menuRef),
          {
    ...
    getToggleButtonProps = (0, import_react20.useCallback)(
      function (_temp4) {
        let { onClick, onPress, refKey = 'ref', ref, ...rest } = _temp4 === void 0 ? {} : _temp4,
          toggleButtonHandleClick = () => {
            dispatch({ type: ToggleButtonClick }),
              !latest.current.state.isOpen && inputRef.current && inputRef.current.focus();
          };
        return {
          [refKey]: handleRefs(ref, (toggleButtonNode) => {
            toggleButtonRef.current = toggleButtonNode;
...
function getA11yRemovalMessage(selectionParameters) {
  let { removedSelectedItem, itemToString: itemToStringLocal } = selectionParameters;
  ...
  Search = import_react21.default.memo(function ({
    ...
    let api = useStorybookApi(),
      ...
      selectStory = (0, import_react21.useCallback)(
        (id, refId) => {
          api && api.selectStory(id, void 0, { ref: refId !== DEFAULT_REF_ID && refId }),
          ...
          switch (changes.type) {
            ...
            case Downshift$1.stateChangeTypes.keyDownEscape:
              return state.inputValue
                ...
                : (inputRef.current.blur(), { ...changes, isOpen: !1, selectedItem: null });
            ...
            case Downshift$1.stateChangeTypes.keyDownEnter: {
              if (isSearchResult(changes.selectedItem)) {
                ...
                return (
                  selectStory(id, refId), { ...changes, inputValue: state.inputValue, isOpen: !1 }
                );
              }
...
var { document: document7 } = scope,
  ...
  Result = import_react22.default.memo(function ({ item, matches, icon, onClick, ...props }) {
...
function filterToolsSide(tools, entry, viewMode, location, path, tabId) {
  let filter = (item) =>
    item &&
    (!item.match ||
      item.match({ storyId: entry?.id, refId: entry?.refId, viewMode, location, path, tabId })) &&
...
var SafeTab = class extends import_react39.Component {
    ...
    render() {
      let { hasError } = this.state,
        { children } = this.props;
      return hasError
        ? import_react39.default.createElement('h1', null, 'Something went wrong.')
        : children;
    }
  },
...
var Centered = newStyled.div({
  ...
  AlertIcon2 = newStyled((props) => import_react59.default.createElement(AlertIcon, { ...props }))(
    ({ theme }) => ({ color: theme.textMutedColor, width: 32, height: 32, margin: '0 auto' }),
  ),
  WhatsNewLoader = () =>
    import_react59.default.createElement(
      Centered,
