...
(self.webpackChunkrmf_dashboard = self.webpackChunkrmf_dashboard || []).push([
  [85724],
  {
    '../../node_modules/.pnpm/@storybook+components@8.0.5_@types+react@18.2.14_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/components/dist/formatter-B5HCVTEV.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function kn(t8) {
          return ('element' === t8.type && (!t8.namespace || de(t8)) && dn[t8.name]) || mn;
        }
        function cr(
          t8,
          e = (function Ti(t8) {
        ...
        function Je(t8) {
          return (
            t8.next && !N(t8.next) && N(t8) && t8.isTrailingSpaceSensitive && !t8.hasTrailingSpaces
          );
        }
        function Ze(t8) {
        ...
        var ns = function Sa(t8, e, r, n) {
            ...
            return /^\s*$/.test(i)
              ...
              : x(
                  i,
                  t8,
                  { parser: '__ng_directive', __isInHtmlAttribute: !1, trailingComma: 'none' },
                  K,
                );
          },
        ...
        function Oe(t8, e, r) {
          ...
          return t8.map((i, a) => {
            ...
            return (
              ...
              C &&
                (Ye(o) ? N(o.next) && m.push(S, S) : C === S ? N(o.next) && m.push(S) : l.push(C)),
          ...
          Pr = class {
            ...
            _isTagStart() {
              if (60 === this._cursor.peek()) {
                ...
                e.advance();
                let r = e.peek();
                if ((97 <= r && r <= 122) || (65 <= r && r <= 90) || 47 === r || 33 === r)
                  return !0;
              }
              return !1;
            }
        ...
        var Kt = class t3 {
          ...
          Nr = class t4 extends Kt {
            ...
            decodeHexDigits(e, r) {
              ...
              if (isNaN(s))
                throw (
                  ((e.state = e.internalState), new ht('Invalid hexadecimal escape sequence', e))
                );
              return s;
            }
          },
          ...
          Or = class t6 {
            ...
            _consumeAttr(e) {
              ...
              let l =
                o &&
                u &&
                new f(s?.sourceSpan.start ?? o.start, u, s?.sourceSpan.fullStart ?? o.fullStart);
              return new Vt(
                r,
                i,
                        ...
                        for (let g of c.attrs)
                          g.namespace ||
                            (g.name = _2(
                              g.name,
                              (y2) =>
                                Jt.has(c.name) && (Jt.get('*').has(y2) || Jt.get(c.name).has(y2)),
                            ));
                    })(c),
                    ((c) => {
                      c.sourceSpan &&
                      ...
                      if (h2 || B) {
                        if (
                          (!h2 || (B && E2.newPos < C.newPos)
                            ? ((m = { newPos: (e = C).newPos, components: e.components.slice(0) }),
            ...
            function gn2(e, t8, r = {}) {
              let n = (r.highlightCode || r.forceColor) && (0, dn2.shouldHighlight)(r),
                ...
                l = (n ? (0, dn2.default)(e, r) : e)
                  ...
                  .join('\n');
              return (
                r.message && !d && (l = `${' '.repeat(f2 + 1)}${r.message}\n${l}`),
                n ? o.reset(l) : l
              );
            }
          }),
        ...
        function kr(e) {
          for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === A2 && y(!1, e, -1).type === b2; )
            e.length -= 2;
          if (e.length > 0) {
            let t8 = Oe2(y(!1, e, -1));
            e[e.length - 1] = t8;
            ...
            : t8 < 0
              ...
              : t8
                ? 'root' === t8.type
                  ...
                  : xt2(
                      e,
                      { type: 'string' == typeof t8 ? 'stringAlign' : 'numberAlign', n: t8 },
                      r,
                    )
                : e;
        }
        ...
        function Qe2(e, t8, r, n, o, u) {
          ...
          for (; r >= 0; ) {
            ...
            switch (U2(c)) {
              ...
              case x2: {
                let f2 =
                  (c.groupId ? o[c.groupId] || K2 : a) === R2 ? c.breakContents : c.flatContents;
            ...
            if (o.parsers)
              for (let u of o.parsers)
                if (!n.has(u)) {
                  n.add(u);
                  let i = r.find(
                      (D) => D.parsers && Object.prototype.hasOwnProperty.call(D.parsers, u),
                    ),
                    s = o.name;
        ...
        function Pt2(e, t8, r = !1) {
          return (
            !1 !== e &&
            (!0 === e ? !!r || [{ value: t8 }] : 'value' in e ? [e] : 0 !== e.length && e)
          );
        }
        function Hr2(e, t8) {
        ...
        var re2 = async function Qu(e, t8 = {}) {
            ...
            let c = {
              ...
              ...(s.defaultOptions
                ? Object.fromEntries(
                    Object.entries(s.defaultOptions).filter(([, f2]) => void 0 !== f2),
                  )
                : {}),
            };
        ...
        function wn2(e, t8) {
          ...
          for (i = r; i > 0; --i) {
            ...
            if (
              !(
                (null == (D = (s = t8.printer).isGap) ? void 0 : D.call(s, f2, t8)) ??
                /^[\s(]*$/.test(f2)
              )
            )
              break;
        ...
        var bo2 = ({ parser: e }) => 'json' === e || 'json5' === e || 'json-stringify' === e;
        function jn2(e) {
          let t8 = e.length - 1;
          for (;;) {
            let r = e[t8];
