...
var debug = Debug('authenticator');
var KeycloakAuthenticator = /** @class */ (function (_super) {
  __extends(KeycloakAuthenticator, _super);
  function KeycloakAuthenticator(config, redirectUri) {
    var _this = _super.call(this) || this;
    _this._initialized = false;
    _this._inst = Keycloak_(config);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            _b.trys.push([2, 4, , 5]);
            return [4 /*yield*/, this._inst.updateToken(30)];
          case 3:
            refreshed = _b.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, this._inst.updateToken(5)];
          case 1:
            refreshed = _a.sent();
            if (refreshed) {
              this._user = this._getUser();
  ...
  KeycloakAuthenticator.prototype.logout = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this._inst.logout()];
          case 1:
            _a.sent();
            throw new Error('should not reach here');
        }
